...
1. Verify you have a CPU with multiple dies by running `lstopo`. If the results appear similar to the first image below, you can proceed:  
    ![CPU Topology](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/lstopo1.webp){: style="display: block;max-height: 300px;" }

    If, on the other hand, your CPU is like this image where the dies are not shown, this will not improve your performace:  
    ![CPU Topology](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/lstopo2.webp){: style="display: block;max-height: 300px;" }
2. Modify the following environment variable to match your system:  
    ...
    ![CPU Topology](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/lstopo3.webp){: style="display: block;max-height: 300px;" }
    ...
    ```
    ![CPU Topology](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/lstopo4.webp)
