...
2. Choose the option to `Edit launch script`  
   ![Edit launch script](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/edit-launch-script.webp){: style="display: block;max-height: 350px;" }
...
2. Choose the option to `Update launch script`
   ![Update launch script](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/update-launch-script.webp){: style="display: block;max-height: 300px;" }
...
5. Remove any EAC workarounds by [editing your launch script](#how-to-edit-the-launch-script) or your game launcher settings, check for each one to see if it exists
    ...
    - In the RSI Launcher, navigate to `Settings -> Games -> LIVE -> Game Location`. If you previously used the Z:\ path workaround, put it back to the default C:\ path  
       ![Game path in launcher](https://cdn.jsdelivr.net/gh/mactan-sc/knowledge-base@main/wiki/assets/images/rsilauncher-default-path.webp){: style="display: block;max-height: 250px;" }  
